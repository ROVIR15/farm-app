...
class ListItemsAndServiceAdapter(private val viewModel: ListItemsAndServiceViewModel) :
    ListAdapter<ProductResponseItem, ListItemsAndServiceAdapter.ViewHolder>(DIFF_CALLBACK) {
        ...
        override fun onMenuItemClick(item: MenuItem?): Boolean {
            when (item?.itemId) {
                R.id.menu_edit -> {
                    ...
                    ItemsAndServiceFragment.IS_UPDATE_DATA = true
