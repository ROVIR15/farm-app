package com.vt.vt.core.data.source.remote.breeding.dto.lambing.create
...
data class LambingRequest(
    ...
    @field:SerializedName("weight_score")
    val weightScore: Double? = null,

    @field:SerializedName("height_score")
    val heightScore: Double? = null,
