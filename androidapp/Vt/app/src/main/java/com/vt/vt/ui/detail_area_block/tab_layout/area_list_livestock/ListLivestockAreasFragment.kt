...
import com.vt.vt.databinding.FragmentListLivestockAreasBinding
...
@AndroidEntryPoint
class ListLivestockAreasFragment : Fragment() {

    private var _binding: FragmentListLivestockAreasBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentListLivestockAreasBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    private fun listAreaLivestock(data: List<LivestockResponseItem>?) {
        val adapter = ListLivestockAreasAdapter(livestockViewModel)
