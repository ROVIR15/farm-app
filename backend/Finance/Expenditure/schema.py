...
from Finance.BudgetSubCategory.schema import BudgetSubCategorySchema
...
class ExpenditureSchema(Schema):
    ...
    budget_sub_category_name = fields.Str(required=True)
    # budget_sub_category = fields.Nested(BudgetSubCategorySchema, require=False)
